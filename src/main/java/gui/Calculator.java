...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
        ...
        String texto_en_pantalla = this.displayText.getText();
        if (texto_en_pantalla.equals("Syntax error.") || texto_en_pantalla.contains("=") ){
            result = 0;
            number1="";
            number2="";
            operator=null;
		...
		switch (value) {
		    ...
		    case "=":
		    	...
		    	try {
                            ...
                            //number2_numer = Long.parseLong(number2);
                            
                             if (operator.equals("+"))
                            {
		    		result = number1_numer + number2_numer;
			    }
                            ...
                            this.displayText.setText(texto_en_pantalla+value+result);
		    	}
		    	catch(NumberFormatException e) {
		    		this.displayText.setText("Syntax error.");
		    	}
